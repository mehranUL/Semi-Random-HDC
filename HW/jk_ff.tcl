...
set my_verilog_files [list  $First_Path/jk_ff.v]
set my_toplevel jk_ff
...
write -format verilog -hierarchy -output Outputs_jk_ff/$filename

set filename [format "%s%s"  $my_toplevel ".ddc"]
write -format ddc -hierarchy -o Outputs_jk_ff/$filename


#redirect Outputs_jk_ff/timing_jk.txt { report_timing -transition_time}
#redirect Outputs_jk_ff/power_jk.txt { report_power }
redirect Outputs_jk_ff/area_jk.txt { report_area }
report_timing
