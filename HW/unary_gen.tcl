...
set my_verilog_files [list  $First_Path/unary_gen.v]
set my_toplevel unary_gen
...
write -format verilog -hierarchy -output Outputs_L_HV_gen/$filename

set filename [format "%s%s"  $my_toplevel ".ddc"]
write -format ddc -hierarchy -o Outputs_L_HV_gen/$filename


redirect Outputs_L_HV_gen/timing_L_HV.txt { report_timing -transition_time}
redirect Outputs_L_HV_gen/power_L_HV.txt { report_power }
#redirect Outputs_L_HV_gen/area_L_HV.txt { report_area }
report_timing
