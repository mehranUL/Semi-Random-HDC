...
#/* M. Hassan Najafi                               */
#/**************************************************/
set First_Path "/home/C00505755/Documents/LD_Synopsys/VDC_HDC"

#/* All verilog files, separated by spaces         */

set my_verilog_files [list  $First_Path/P_HV_image.v $First_Path/jk_ff.v $First_Path/vdc.v]
set my_toplevel P_HV_image
...
write -format verilog -hierarchy -output Outputs_P_HV_image/$filename

set filename [format "%s%s"  $my_toplevel ".ddc"]
write -format ddc -hierarchy -o Outputs_P_HV_image/$filename


#redirect Outputs_P_HV_image/timing_P_HV.txt { report_timing -transition_time}
#redirect Outputs_P_HV_image/power_P_HV.txt { report_power }
redirect Outputs_P_HV_image/area_P_HV.txt { report_area }
report_timing
