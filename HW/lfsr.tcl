...
set my_verilog_files [list  $First_Path/lfsr.v]
set my_toplevel lfsr1024
...
write -format verilog -hierarchy -output Outputs_lfsr/$filename

set filename [format "%s%s"  $my_toplevel ".ddc"]
write -format ddc -hierarchy -o Outputs_lfsr/$filename


redirect Outputs_lfsr/timing_lfsr.txt { report_timing -transition_time}
redirect Outputs_lfsr/power_lfsr.txt { report_power }
#redirect Outputs_lfsr/area_lfsr.txt { report_area }
report_timing
