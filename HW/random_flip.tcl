...
set my_verilog_files [list  $First_Path/random_flip.v]
set my_toplevel random_flip
...
write -format verilog -hierarchy -output Outputs_random_flip/$filename

set filename [format "%s%s"  $my_toplevel ".ddc"]
write -format ddc -hierarchy -o Outputs_random_flip/$filename


redirect Outputs_random_flip/timing_random_flip.txt { report_timing -transition_time}
redirect Outputs_random_flip/power_random_flip.txt { report_power }
#redirect Outputs_random_flip/area_random_flip.txt { report_area }
report_timing
